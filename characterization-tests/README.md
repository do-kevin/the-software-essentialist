...
## Generating tests for features

```node node_modules/@amiceli/vitest-cucumber/dist/cli-generate.mjs --feature tests/features/create-classroom.feature --spec tests/e2e/createClassroom.test.ts

```

```
npx @amiceli/vitest-cucumber --feature tests/features/create-classroom.feature --spec tests/e2e/createClassroom.test.ts
```
